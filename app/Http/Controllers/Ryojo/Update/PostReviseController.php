...
class PostReviseController extends Controller
{
    ...
    public function __invoke(Request $request,RyojoService $ryojoservice)
    {
        ...
        return view('ryojo.ud-textform',compact('memory','title','content','tags','prefs','selectedtagsId','selectedprefsName','Tohokuprefs',
                                                'Kantoprefs','Chubuprefs','Kinkiprefs','Chugokuprefs','Shikokuprefs','Kyusyuprefs'));
