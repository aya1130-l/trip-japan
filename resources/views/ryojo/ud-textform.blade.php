<x-layoutgray title="旅情 -日本旅行記投稿フォーム-">
    <p class="text-center mt-24  text-lg text-gray-800">< テキストの編集 ></p>
    <div class="w-11/12 md:w-[650px] min-h-[550px] m-auto mt-4 border-4 border-gray-400 bg-white rounded-lg">
        <div class="m-auto mt-4 w-5/6">
            <x-auth-validation-errors class="mb-4" :errors="$errors" />
        </div>
        <form action="{{ route('ryojo.update.select', ['memoryId' => $memory->id]) }}" method="post">  
                @csrf                 
                @if(!isset($title))
                    <div class="m-auto mt-8 w-5/6">
                        <p class="text-gray-800">title:</p>
                        <textarea type="text" name="title" placeholder="旅行記に題名をつけましょう" class="block border-2 border-gray-300 w-full rounded resize-none h-12">{{ $memory->title }}</textarea>
                    </div>
                    <div class="m-auto mt-8 w-5/6">
                        <p class="text-gray-800">content:</p>
                        <textarea name="content" placeholder="1000字まで" class="block border-2 border-gray-300 w-full h-40 rounded resize-none">{{ $memory->content }}</textarea>
                    </div>
                @else
                    <div class="m-auto mt-8 w-5/6">
                        <p class="text-gray-800">title:</p>
                ...
                <div class="m-auto mt-8 w-5/6 z-10 pointer-events-none">
                    <div x-data="setPrefectures()"> 
                            ...
                            <div class="bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700">
                                <ul class="py-1 text-sm text-gray-700 dark:text-gray-200">
                                    ...
                                    <li class="pointer-events-auto relative">
                                        ...
                                        <div x-show='kanto' class="absolute z-10 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700" @click.away=" kanto = ''">
                                    ...
                                    <li class="pointer-events-auto relative">
                                        ...
                                        <div x-show='chubu' class="absolute z-10 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700" @click.away=" chubu = ''">
                                    ...
                                    <li class="pointer-events-auto relative">
                                        ...
                                        <div x-show='kinki' class="absolute z-10 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700" @click.away=" kinki = ''">
                                    ...
                                    <li class="pointer-events-auto relative">
                                        ...
                                        <div x-show='chugoku' class="absolute z-10 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700" @click.away=" chugoku = ''">
                                    ...
                                    <li class="pointer-events-auto relative">
                                        ...
                                        <div x-show='shikoku' class="absolute z-10 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700" @click.away=" shikoku = ''">
                                    ...
                                    <li class="pointer-events-auto relative">
                                        ...
                                        <div x-show='kyusyu' class="absolute z-10 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700" @click.away=" kyusyu = ''">
    ...
    <button type="submit" class="block w-1/2 md:w-1/4 h-12 inset-0 top-[750px] m-auto mt-20 mb-8 bg-[#001a1a] hover:bg-[#1e3333] text-center text-white rounded-lg">次へ</button>
    <a onClick="history.back();" class="block w-1/2 md:w-1/4 h-12 mx-auto mb-20 py-3 bg-[#b3a7a1] hover:bg-[#ccc1b8] text-center text-white rounded-lg cursor-pointer">戻る</a>        
