<x-layoutgray title="旅情 -日本旅行記投稿フォーム-">
    ...
    <div class="w-11/12 md:w-[650px] min-h-[880px] m-auto mt-4 border-4 border-gray-400 bg-white rounded-lg">
        <div class="m-auto mt-4 w-5/6">
            <x-auth-validation-errors class="mb-4" :errors="$errors" />
        </div>
        <form action="{{ route('ryojo.confirm') }}" method="post" enctype="multipart/form-data"> 
                @csrf
                @if(old('title') or old('content'))
                    ...
                    <div class="m-auto mt-8 w-5/6">
                        ...
                        <textarea name="content" placeholder="" class="block border-2 border-gray-300 w-full h-40 rounded resize-none">{{ old('content') }}</textarea>
                    </div>
                @else
                    <div class="m-auto mt-8 w-5/6">
                        <p class="text-gray-800">title:</p>
                    ...
                    <div class="m-auto mt-8 w-5/6">
                        <p class="text-gray-800">content:</p>
                        <textarea name="content" placeholder="" class="block border-2 border-gray-300 w-full h-40 rounded resize-none">{{ $content }}</textarea>
                    </div> 
                @endif
    ...
    <button type="submit" class="block md:w-2/5 w-[200px] h-12 mx-auto mt-20 mb-8 bg-[#001a1a] hover:bg-[#1e3333] text-white rounded-lg">投稿内容を確認する</button>        
